...
import gymnastics.benchmarks.pycls.models.nas_bench.base_ops as base_ops
from gymnastics.benchmarks.pycls.models.nas_bench.model_spec import ModelSpec
    ...
    def __init__(self):
        ...
        if "cifar" in cfg.TRAIN.DATASET:
            ...
            self.stem = nn.Sequential(
                base_ops.conv_bn_relu(
                    cfg.MODEL.INPUT_CHANNELS, out_channels // 2, 3, 2, 1
                ),
