...
from gymnastics.benchmarks.pycls.models.common import Preprocess
from gymnastics.benchmarks.pycls.models.common import Classifier
from gymnastics.benchmarks.pycls.models.nas.genotypes import GENOTYPES
from gymnastics.benchmarks.pycls.models.nas.genotypes import Genotype
from gymnastics.benchmarks.pycls.models.nas.operations import FactorizedReduce
from gymnastics.benchmarks.pycls.models.nas.operations import OPS
from gymnastics.benchmarks.pycls.models.nas.operations import ReLUConvBN
from gymnastics.benchmarks.pycls.models.nas.operations import Identity
...
class NetworkImageNet(nn.Module):
    ...
    def __init__(self, C, num_classes, layers, auxiliary, genotype):
        ...
        reduction_prev = True
        reduction_layers = (
            [layers // 3] if cfg.TASK == "seg" else [layers // 3, 2 * layers // 3]
        )
        for i in range(layers):
...
class NAS(nn.Module):
    ...
    def __init__(self):
        ...
        assert cfg.NAS.GENOTYPE in GENOTYPES, "Genotype {} not supported".format(
            cfg.NAS.GENOTYPE
        )
