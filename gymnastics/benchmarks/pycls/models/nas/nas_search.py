...
from gymnastics.benchmarks.pycls.models.nas.operations import *
from gymnastics.benchmarks.pycls.models.nas.genotypes import DARTS_OPS as PRIMITIVES
    ...
    def __init__(
        ...
        if "cifar" in cfg.TRAIN.DATASET:
            ...
            self.stem0 = nn.Sequential(
                nn.Conv2d(
                    cfg.MODEL.INPUT_CHANNELS, C // 2, 3, stride=2, padding=1, bias=False
                ),
                nn.BatchNorm2d(C // 2),
