...
parser.add_argument("--data", default="/disk/scratch_ssd/nasbench201/cifar10",  help="path to dataset")
parser.add_argument(
    "-j",
    "--workers",
    default=1,
...
parser.add_argument(
    ...
    default="cnn",
    type=str,
    help="We will suffix this with _seed.t7",
)
...
def full_training_run(model: nn.Module, search_space_name: str = None):
    ...
    dataset = CIFAR10Loader(args.data, val_split_percentage=0.0)
    train_loader, val_loader = dataset.train_loader, dataset.test_loader
    if args.evaluate:
...
if __name__ == "__main__":
    ...
    dataset = CIFAR10Loader("/disk/scratch_ssd/nasbench201/cifar10")
